...
public class ConsoleReader {
	 ...
	 * inclusive. Note, repeatedly prompts the user until a valid value is entered.
	 * 
	 * @param prompt
	 *            output to the user before waiting for input
	 * @param low
	...
	/**
	 * Prompts the user to input yes or no to the given question. Note, repeatedly
	 * prompts the user until yes or no is entered.
	 * 
	 * @param prompt
	 *            output to the user before waiting for input
	 * @return the value entered, waiting if necessary until one is given
